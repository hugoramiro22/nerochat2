...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do Atendeocta que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador Atendeocta, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar Atendeocta\n"
  printf "   [1] Atualizar Atendeocta\n"
  printf "   [2] Deletar Atendeocta\n"
  printf "   [3] Bloquear Atendeocta\n"
  printf "   [4] Desbloquear Atendeocta\n"
  printf "   [5] Alter. dominio Atendeocta\n"
  printf "\n"
  read -p "> " option
